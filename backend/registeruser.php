...
if (isset($_POST["username"]) && isset($_POST["useremail"]) && isset($_POST["usercontact"]) && isset($_POST["useradmno"]) && isset($_POST["usergender"]) && isset($_POST["userpassword"]) ){
    ...
    $sql = "INSERT INTO students (username,useremail,usercontact,userregno,usergender,userpassword) VALUES ('$username','$useremail','$usercontact','$userregno','$usergender','$userpassword')";
    if($conn->query($sql)){
        echo json_encode(["success" => true,"message" => "Registration is succsessful"]);
    } else {
